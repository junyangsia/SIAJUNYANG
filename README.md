...
![photo_2026-01-19_15-22-23](https://github.com/user-attachments/assets/15b3d0e2-4408-49ff-83b6-d32f24dd0e57)

## 👋 About Me
Hi, I am a student from **Universiti Teknologi Malaysia (UTM)**, Faculty of Computing. I am currently majoring in **Network and Cybersecurity**. I am passionate about technology and eager to develop my professional skills through hands-on projects and academic learning.

## 🎓 Education
* **Universiti Teknologi Malaysia (UTM)**
  * Bachelor of Computer Science(Computer Networks & Security) with Honours
  * *Relevant Coursework:* Technology and Information System (SECP1513)

## 🛠 Skills
* **Technical:** PC Hardware Assembly, Design Thinking, Basic Networking
* **Programming:** C++ (Currently learning)
* **Soft Skills:** Problem Solving, Team Collaboration, Technical Writing

---

## 📂 TIS Course Portfolio (SECP1513)
This section showcases my learning progression and achievements in the Technology and Information Systems course. You can find all artifacts and my detailed reflections in the link below:
